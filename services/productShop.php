<?php
    ...
    include_once '../models/productShop.php';


    class ProductServiceShop {
        private $connection;
        private $tblCategories = "tblCategories";
        private $tblProductsshop = "tblProductsshop";
        ...
        public function getById($id){
            try {
                $q = "SELECT id_shop, name, price, quantity, image_url, category_id
                     from " . $this->tblProductsshop . " where id_shop=:id_shop ";
        ...
        public function getAllProductsShop(){
            try {
                $q = "SELECT id_shop, name, price, quantity, image_url, category_id
                     from " . $this->tblProductsshop . " order by id_shop desc ";
                $stmt = $this->connection->prepare($q);                
        ...
        {
            try {
                $q = "insert into " . $this->tblProductsshop . "
                        set name=:name,
                        price=:price,
                        quantity=:quantity,
                        image_url=:image_url,
